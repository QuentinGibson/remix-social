        ...
        <userFetcher.Form method="post">
          ...
          <div className="flex mt-4">
            <button
              id="save-profile"
              type="submit"
              className="px-3 py-2 mr-8 text-white rounded-xl"
              style={{ background: themeContext.accent }}
            >
              Save
            </button>
            <Link
              className="px-2 py-2 text-white rounded-lg bg-slate-500 hover:bg-slate-400"
              id="view-profile"
        ...
        {user.isAdmin && (
          <div className="flex gap-8 mx-auto max-screen-w-md">
            <Form method="post" action="/api/admin/populatePosts">
              <button
                id="admin-posts"
                className="px-2 py-2 text-white bg-red-500 rounded-lg hover:bg-red-400"
              >
                Create Sample Posts
              </button>
            </Form>
